...
class AuthGroupsDbUpdate extends AuthError {
...
class AuthGroupNotFound extends AuthError {
    constructor(e, { id, err } = {}) {
        super(e);
        this.id = id;
        this.err = err;
...
class AuthNoGroupsFound extends AuthError {
    constructor(e, { memberId, memberEmail, err } = {}) {
        super(e);
...
class AuthNotAuthorized extends AuthError {
    constructor(e, { userId, groupId } = {}) {
        super(e);
        this.userId = userId;
